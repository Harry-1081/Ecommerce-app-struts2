...
public class SuperAdminController extends ActionSupport implements SessionAware
{    
    int id;
    ...
    public HttpHeaders index() throws SQLException, ClassNotFoundException {
        HttpServletRequest request = ServletActionContext.getRequest();
        boolean defCall = "XMLHttpRequest".equals(request.getHeader("X-Requested-With"));

        if (!defCall) {
            return new DefaultHttpHeaders("Superadmin").disableCaching();
        } else {
